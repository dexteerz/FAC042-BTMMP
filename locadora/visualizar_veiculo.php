  ...
  <div class="box-body">
    ...
    <input type="hidden" name="id" value="<?=$id?>">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
            <select disabled id="idCategoria" name="idCategoria"  class="form-control input-md">
              }
              <?php 
                foreach ($resultado as $categoria) { 
                  if($veiculo['idCategoria'] == $categoria['idCategoria']) {
                    echo '<option disabled value="'.$veiculo['idCategoria'].'" selected>'.$categoria['descricao'].'</option>';
                  }
                };
              ?>
            </select>
        ...
        <div class="col-md-4">
          <div class="radio">
            <label disabled for="radios-0">
              <input disabled type="radio" name="status" id="radios-1" value="1" <?=$veiculo['status'] == '1' ? 'checked="checked"' : '';?>>
              Ativo
            </label>
          </div>
          <div class="radio">
              <label disabled for="radios-1">
              <input disabled type="radio" name="status" id="radios-0" value="0"<?=$veiculo['status'] == '0' ? 'checked="checked"' : '';?>>
              Inativo
            </label>
          </div>
        </div>
