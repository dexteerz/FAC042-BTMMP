...
<div class="box">
  ...
  <div class="box-body">
  <form class="form-horizontal" action="model/atualizar_usuario.php" method="post">
      <fieldset>
      <!-- Form Name -->
      <!-- Select Basic -->
      <div class="form-group">
        ...
        <div class="col-md-4">
          ...
          <option   value="1" <?php echo $usuario['idPerfilUsuario'] == '1' ? 'selected':''?>>Administrador</option>
          <option   value="2" <?php echo $usuario['idPerfilUsuario'] == '2' ? 'selected':''?>>Funcionario</option>
          <option   value="3" <?php echo $usuario['idPerfilUsuario'] == '3' ? 'selected':''?>>Usuario</option>
      ...
      <div class="form-group">
        ...
        <div class="col-md-4">
          <div class="radio">
            <label for="radios-0">
              <input type="radio" name="status" id="radios-1" value="1" <?=$usuario['status'] == '1' ? 'checked="checked"' : '';?>>
              Ativo
            </label>
          </div>
          <div class="radio">
              <label for="radios-1">
              <input type="radio" name="status" id="radios-0" value="0"<?=$usuario['status'] == '0' ? 'checked="checked"' : '';?>>
              Inativo
            </label>
          </div>
        </div>
