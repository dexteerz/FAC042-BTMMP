...
(1, 1, '1', 'Breno Teixeira', 'inf.teixeira@gmail.com', 'AGzzcso1$', 'Rua La casa do Carallo', '2018-10-29 16:59:00', 1),
...
(2, 'AAA-5123', 'BBBB', 'MODELO 2', 'ROSA', 2, 1, '2018-11-02 14:23:52'),
(3, 'ADW-1231', 'CCCC', 'MODELO 3', 'AZUL', 2, 1, '2018-11-02 14:23:52'),
(4, 'CAA-1345', 'DDDD', 'MODELO 4', 'PRETO', 2, 1, '2018-11-02 14:23:52'),
(5, 'VVD-6760', 'EEEE', 'MODELO 5', 'PRETO', 2, 1, '2018-11-02 14:23:52'),
(6, 'CXS-6543', 'FFFF', 'MODELO 6', 'PRATA', 2, 0, '2018-11-02 14:23:52'),
(7, 'CCC-5141', 'GGGG', 'MODELO 7', 'PRATA', 2, 1, '2018-11-02 14:23:52'),
(8, 'VAS-1809', 'HHHH', 'MODELO 8', 'AZUL', 2, 1, '2018-11-02 14:23:52'),
(9, 'FFF-8645', 'IIII', 'MODELO 9', 'AZUL', 2, 0, '2018-11-02 14:23:53'),
(10, 'CAA-8999', 'JJJJ', 'MODELO 10', 'PRETO', 5, 1, '2018-11-02 14:23:53'),
(11, 'DSS-2351', 'KKKK', 'MODELO 11', 'AMARELO', 2, 1, '2018-11-02 14:23:53'),
(12, 'CXZ-5161', 'LLL', 'MODELO 12', 'ROSA', 2, 0, '2018-11-04 21:56:21'),
(13, 'ZXC-2166', 'QQQQ', 'MODELO 13', 'AMARELO', 2, 1, '2018-11-02 14:23:53'),
(14, 'XXA-7899', 'GGG', 'MODELO 99', 'AMARELO', 2, 1, '2018-11-04 21:56:16'),
(15, 'AAA-3210', '123', 'CARRO', 'PRETO', 15, 0, '2018-11-04 21:44:29');


CREATE TABLE `view_veiculocat` (
`idVeiculo` int(11)
,`placa` varchar(20)
,`chassi` varchar(50)
,`modelo` varchar(50)
...
CREATE TABLE `v_veiculocategoria` (
`placa` varchar(20)
,`chassi` varchar(50)
,`modelo` varchar(50)
,`cor` varchar(50)
